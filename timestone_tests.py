...
class TestFileHandlers(unittest.TestCase):
    ...
    def test_raw_to_batch_runs(self):
        ...
        self.assertEqual(os.listdir('test_data/Stage2-deduped_eda_cleaned/')[0], '20190801_20190831')
        self.assertEqual(os.listdir('test_data/Stage2-deduped_eda_cleaned/20190801_20190831')[0], 'eda')
        self.assertEqual(os.listdir('test_data/Stage2-deduped_eda_cleaned/20190801_20190831/eda')[0], 'eda_combined_0.csv')

        df = pd.read_csv('test_data/Stage2-deduped_eda_cleaned/20190801_20190831/eda/eda_combined_0.csv')
